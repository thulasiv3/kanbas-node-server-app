...
const module = {
    id: 8, name: "Rocket Propulsion",
    description: "Propel a rocket",
...
const Lab5 = (app) => {
    ...
    app.get("/a5/todos/create", (req, res) => {
      ...
      //DELETE CRUD OPERATION USING DELETE
    ...
    // HAVE TO IMPLEMENT CHECKBOX FOR COMPLETED
    ...
    app.get("/a5/assignment/completed/:newCompleted", (req, res) => {
        ...
        // Assuming `assignment` is your assignment object
